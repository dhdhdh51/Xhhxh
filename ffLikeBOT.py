...
def vip_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📢 Join Channel", url="https://t.me/Pythonbotz")],
        [InlineKeyboardButton(text="💎 Buy VIP", url="https://t.me/metaui")],
    ])

def verify_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="✅ Verify For Extra Likes", url="https://inshorturl.com/tterQNUy")],
    ])
